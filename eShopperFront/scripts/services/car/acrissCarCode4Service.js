/**
 * Created by yzaghir on 29/06/2016.
 */
angular.module("eShopperApp")
    .factory("acrissCarCode4Service" ,['$resource' , '$q','$http' , "CConfigCar",
        function($resource , $q ,$http , CConfigCar){

            var service ={
                urlRest : CConfigCar.acrissCarCode4.url ,
                donnees: [],
                apiRest: apiRest,
                add: add ,
                update:update,
                ...
                var resultRest = $resource(service.urlRest)
                    .query().$promise.then(function(data){
                        data.forEach(function(element){
                            result.push({
                                code: element.code,
                                airCondition: element.airCondition,
                                fuel: element.fuel ,
                                activedCss:"" ,
                                actived:true })  ;
                        });
